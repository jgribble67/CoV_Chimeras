...
parser.add_argument("Working_Directory", help="Path to directory containing BED files")
...
for name in samples:
    ...
    # command = 'samtools fasta -n -@ 32 ' + name + '_SARS2.sort.bam > ' + name + '.fasta'
    ...
    command2 = "sed 's/..$//' " + name + "_read_names.txt > " + name + "_read_names.txt"
    command3 = "seqtk subseq " + name + ".fasta " + name + "_read_names.txt > " + name + "_recombined.fasta"
